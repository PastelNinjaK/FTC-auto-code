...
;
    ...
    if (opModeIsActive()) {
      while (opModeIsActive()) {
        ...
        program(-1.0, 1.0, 1000);  // Rotate(can't change this rn cuz we need to find the time it take for the robot to turn 90 degrees).
        program(1.0, 1.0, time * 4);   // Forward (Time is multiplied by 4 because the variable time is calculating how long it take for the robot to travel across 1 Tile).
        program(1.0, -1.0, 1000);  // Rotate for parking(Same for the first rotate)
