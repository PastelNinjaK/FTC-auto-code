...
public class Auto2425 extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
        ...
        program(1.0, 1.0, time * 0.5); // Forward (Time is multiplied by 0.5 because the variable time is calculating how long it take for the robot to travel across 1 Tile).
